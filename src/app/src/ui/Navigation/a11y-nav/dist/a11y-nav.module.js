  ...
  return (
    ...
    (n.closeMenu = function (t) {
      ...
      if (t.el.classList.contains('a11y-nav-active')) {
        ...
        setTimeout(() => {
          var button_ = document.querySelector("[class*='navigation_hamburger']");
          button_.setAttribute('aria-expanded', 'false');
          return n();
        }, 100);
      }
    }),
...
export { e as default };
//# sourceMappingURL=a11y-nav.module.js.map
